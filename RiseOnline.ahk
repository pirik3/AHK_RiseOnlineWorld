...
WarriorAttackDungeon()
{
  ...
  Sleep, 10
  ControlSend,,{8 Down}{8 Up},AHK_exe RiseOnline-Win64-Shipping.exe
  ;~ PixelSearch, OutputVarX, OutputVarY, 808, 70, 808, 70, 0xEDEDED ;yaratik bari gorunuyorsa
  ;~ if (!ErrorLevel)
  ;~ {
    ;~ ControlSend,,{4 Down}{4 Up},AHK_exe RiseOnline-Win64-Shipping.exe
    ;~ Sleep, 10
...
{
  ;CoordMode Pixel, Window	; CoordMode, ToolTip|Pixel|Mouse|Caret|Menu [, Screen|Window|Client]
  PixelGetColor, hp90,  314,  105 ; 0x585EE5
  PixelGetColor, hp80,  182,  62
  PixelGetColor, hp70,  163,  62
  PixelGetColor, hp50,  209, 105 ; 0x535AE2
  PixelGetColor, hp30,  146, 105
  ;ToolTip, %hp90%
  if (ok:=FindText(X, Y, 1604, 362, 1688, 436, 0, 0, AxeOfDestruction)) and (hp50 != 0x535AE2)
  ;if(hp50 != 0x535AE2) ; HP
  ;if(hp90 != 0x100CFF)
  {
    ;ToolTip, %hp30%
    ...
    ;~ Sleep, 10
    ControlClick, x1555 y528, AHK_exe RiseOnline-Win64-Shipping.exe, , Right
    Sleep, 50 ; seri sag click atmamasi icin
    ;ControlSend,,{Esc Down}{Esc Up},AHK_exe RiseOnline-Win64-Shipping.exe
  }
  if (ok:=FindText(X, Y, 1604, 362, 1688, 436, 0, 0, WillBreaker)) and (hp90 = 0x585EE5)
  ;if(hp50 != 0x535AE2) ; HP
  ;if(hp90 != 0x100CFF)
  {
    ;ToolTip, %hp30%
...
{
Sleep, 10
ControlClick, x1559 y533, AHK_exe RiseOnline-Win64-Shipping.exe, , Right
Sleep, 10
ControlSend,,{Esc Down}{Esc Up},AHK_exe RiseOnline-Win64-Shipping.exe
Sleep, 10
ControlSend,,{Esc Down}{Esc Up},AHK_exe RiseOnline-Win64-Shipping.exe
